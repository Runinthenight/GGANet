...
def get_default_ogbg_molhiv_task_names():
    """Get that default ogbg_molhiv task names and return class label"""
    return ['HIV_active']


def load_ogbg_molhiv_dataset(data_path, task_names=None):
    """tbd"""
    if task_names is None:
        task_names = get_default_ogbg_molhiv_task_names()
...
def split_ogbg_molhiv_by_ogbg_scaffold(data_path, dataset):
    """tbd"""
